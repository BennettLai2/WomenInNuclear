...
class AccountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update account" do
    patch account_url(@account), params: { account: { admin: @account.admin, email: @account.email, first_name: @account.first_name, last_name: @account.last_name, password: @account.password, points: @account.points } }
